...
public class Classify extends AppCompatActivity {
    ...
    //holds all possible labels for model
    private List<String> labelList;
    //holds the selected image data as bytes
    private ByteBuffer imgData = null;
    // holds the probabilities of each label for Inception graphs
    private float[][] labelProbArray = null;
    // holds the probabilities of each label for ModelVnet graphs
    private byte[][] labelProbArrayB = null;
    // holds the probabilities of each label for EfficientNet graphs
    private byte[][] labelProbArrayC = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chosen = (String) getIntent().getStringExtra("modelChosen");
        ...
        // initialize probabilities array. The datatypes that array holds depends if the input data needs to be which model
        ...
        classify_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Convert bitmap array to byte Array
    ...
    private MappedByteBuffer loadModelFile() throws IOException {
        AssetFileDescriptor assetFileDescriptor = this.getAssets().openFd(chosen);
